...
export const content = {
  es: {
    ...
    globe: {
      ...
      noResultsBody:
        "Que no esté en el mapa no significa que no podamos armarlo. Cotízalo y te respondemos con un plan a tu medida.",
  ...
  en: {
    ...
    globe: {
      ...
      noResultsBody:
        "Not being on the map doesn't mean we can't plan it. Ask for a quote and we'll get back to you with a tailored trip.",
